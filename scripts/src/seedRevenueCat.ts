...
const PROJECT_NAME = "Quran Recitation Splitter";
...
const PRODUCT_USER_FACING_TITLE = "Pro Monthly";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Quran Recitation Splitter";
const APP_STORE_BUNDLE_ID = "com.quransplitter.app";
const PLAY_STORE_APP_NAME = "Quran Recitation Splitter";
const PLAY_STORE_PACKAGE_NAME = "com.quransplitter.app";
...
// $1.00 / month
const PRODUCT_PRICES = [{ amount_micros: 1000000, currency: "USD" }];
